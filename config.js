...
const // Short text, center-aligned, useful for a little side info, credits, links to measurement setup, etc.
  ...
  paragraphs = `
      ...
      <p class="center" style="text-align: center;">EX이헤갤러, FiiO=GOD, IER-M9_Kuromi, JohnYang1997, Lastwhitespace, Ricopam, RSGARU, SilicaGel, SeanOlive</p>
      <p class="center" style="text-align: center;">초급자, 뎃데로게., 돼지고닉해드, 방사능홍차, 보안폴더, 유키나유키농, 장발장, 전염, 프리스트, 피프틴유저, ㅓㅣ</p>
    `,
